...
func (n *ToolNamespace) Get(suffix string, _ variable.Source, ctx variable.ResolveContext) (any, bool) {
	switch suffix {
	case "name":
...
func (n *ToolNamespace) Enumerate(_ variable.Source, ctx variable.ResolveContext) map[string]any {
